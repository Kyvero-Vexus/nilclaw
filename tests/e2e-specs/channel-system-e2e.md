# E2E Spec: Channel System Specification
...
## Scope
Validate `specs/extracted/channel-system.md` behavior via running-app interfaces only (CLI, gateway APIs, channels, MCP/tool calls).
...
- Validate **Channel Interface** through real CLI/API/channel interactions.
- Validate **Built-in Channels** through real CLI/API/channel interactions.
- Validate **Permission System** through real CLI/API/channel interactions.
- Validate **Multi-Account Support** through real CLI/API/channel interactions.
- Validate **Message Splitting** through real CLI/API/channel interactions.
- Validate **Channel Dispatch** through real CLI/API/channel interactions.
- Validate **Channel Lifecycle** through real CLI/API/channel interactions.
...
## Traceability
- Source spec: `specs/extracted/channel-system.md`
- Bead: `nilclaw-o0v`
