# E2E Spec: Streaming & Voice Specification
...
## Scope
Validate `specs/extracted/streaming-voice.md` behavior via running-app interfaces only (CLI, gateway APIs, channels, MCP/tool calls).
...
- Validate **Streaming** through real CLI/API/channel interactions.
- Validate **Voice (Speech-to-Text)** through real CLI/API/channel interactions.
- Validate **SSE Client** through real CLI/API/channel interactions.
- Validate **Integration Points** through real CLI/API/channel interactions.
- Validate **Configuration** through real CLI/API/channel interactions.
- Validate **Constraints** through real CLI/API/channel interactions.
...
## Traceability
- Source spec: `specs/extracted/streaming-voice.md`
- Bead: `nilclaw-f6f`
