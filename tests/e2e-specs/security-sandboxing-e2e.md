# E2E Spec: Security & Sandboxing Specification
...
## Scope
Validate `specs/extracted/security-sandboxing.md` behavior via running-app interfaces only (CLI, gateway APIs, channels, MCP/tool calls).
...
- Validate **Autonomy Levels** through real CLI/API/channel interactions.
- Validate **Command Security Policy** through real CLI/API/channel interactions.
- Validate **Sandbox Isolation** through real CLI/API/channel interactions.
- Validate **Secret Encryption** through real CLI/API/channel interactions.
- Validate **Pairing System** through real CLI/API/channel interactions.
- Validate **Audit Logging** through real CLI/API/channel interactions.
- Validate **Rate Limiting** through real CLI/API/channel interactions.
...
## Traceability
- Source spec: `specs/extracted/security-sandboxing.md`
- Bead: `nilclaw-7k0`
