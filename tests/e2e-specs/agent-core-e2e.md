# E2E Spec: Agent Core & Session Management Specification
...
## Scope
Validate `specs/extracted/agent-core.md` behavior via running-app interfaces only (CLI, gateway APIs, channels, MCP/tool calls).
...
- Validate **Session Management** through real CLI/API/channel interactions.
- Validate **Agent Structure** through real CLI/API/channel interactions.
- Validate **Turn Loop** through real CLI/API/channel interactions.
- Validate **Context Token Resolution** through real CLI/API/channel interactions.
- Validate **Max Tokens Resolution (Generation Cap)** through real CLI/API/channel interactions.
- Validate **History Compaction** through real CLI/API/channel interactions.
- Validate **History Trimming** through real CLI/API/channel interactions.
...
## Traceability
- Source spec: `specs/extracted/agent-core.md`
- Bead: `nilclaw-so0`
