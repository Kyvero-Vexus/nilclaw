# E2E Spec: Identity & Workspace Files Specification
...
## Scope
Validate `specs/extracted/identity-workspace.md` behavior via running-app interfaces only (CLI, gateway APIs, channels, MCP/tool calls).
...
- Validate **Workspace Bootstrap Files** through real CLI/API/channel interactions.
- Validate **System Prompt Assembly** through real CLI/API/channel interactions.
- Validate **File Security Guards** through real CLI/API/channel interactions.
- Validate **Fingerprinting** through real CLI/API/channel interactions.
- Validate **Bootstrap Provider Interface** through real CLI/API/channel interactions.
- Validate **AIEOS Identity Format (v1.1)** through real CLI/API/channel interactions.
- Validate **Integration Points** through real CLI/API/channel interactions.
...
## Traceability
- Source spec: `specs/extracted/identity-workspace.md`
- Bead: `nilclaw-qpv`
