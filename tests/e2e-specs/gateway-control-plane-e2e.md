# E2E Spec: Gateway & Control Plane Specification
...
## Scope
Validate `specs/extracted/gateway-control-plane.md` behavior via running-app interfaces only (CLI, gateway APIs, channels, MCP/tool calls).
...
- Validate **Data Model** through real CLI/API/channel interactions.
- Validate **HTTP Server** through real CLI/API/channel interactions.
- Validate **Endpoints** through real CLI/API/channel interactions.
- Validate **Authentication** through real CLI/API/channel interactions.
- Validate **Agent Routing** through real CLI/API/channel interactions.
- Validate **Tool Event Observer** through real CLI/API/channel interactions.
- Validate **Control Plane (Slash Commands)** through real CLI/API/channel interactions.
...
## Traceability
- Source spec: `specs/extracted/gateway-control-plane.md`
- Bead: `nilclaw-am3`
