# E2E Spec: Skills System Specification
...
## Scope
Validate `specs/extracted/skills-system.md` behavior via running-app interfaces only (CLI, gateway APIs, channels, MCP/tool calls).
...
- Validate **Skill Directory Structure** through real CLI/API/channel interactions.
- Validate **Skill Definition** through real CLI/API/channel interactions.
- Validate **Manifest Formats** through real CLI/API/channel interactions.
- Validate **Loading Process** through real CLI/API/channel interactions.
- Validate **System Prompt Injection** through real CLI/API/channel interactions.
- Validate **Skill Installation** through real CLI/API/channel interactions.
- Validate **Skill Removal** through real CLI/API/channel interactions.
...
## Traceability
- Source spec: `specs/extracted/skills-system.md`
- Bead: `nilclaw-pwk`
