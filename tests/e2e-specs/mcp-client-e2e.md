# E2E Spec: MCP Client Specification
...
## Scope
Validate `specs/extracted/mcp-client.md` behavior via running-app interfaces only (CLI, gateway APIs, channels, MCP/tool calls).
...
- Validate **Protocol** through real CLI/API/channel interactions.
- Validate **McpServer** through real CLI/API/channel interactions.
- Validate **McpToolWrapper** through real CLI/API/channel interactions.
- Validate **Initialization** through real CLI/API/channel interactions.
- Validate **Error Handling** through real CLI/API/channel interactions.
...
## Traceability
- Source spec: `specs/extracted/mcp-client.md`
- Bead: `nilclaw-ie8`
