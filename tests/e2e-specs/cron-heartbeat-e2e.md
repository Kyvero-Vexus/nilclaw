# E2E Spec: Cron & Heartbeat Specification
...
## Scope
Validate `specs/extracted/cron-heartbeat.md` behavior via running-app interfaces only (CLI, gateway APIs, channels, MCP/tool calls).
...
- Validate **Cron Jobs** through real CLI/API/channel interactions.
- Validate **Heartbeat System** through real CLI/API/channel interactions.
- Validate **Scheduler Configuration** through real CLI/API/channel interactions.
...
## Traceability
- Source spec: `specs/extracted/cron-heartbeat.md`
- Bead: `nilclaw-a84`
