# E2E Spec: Memory System Specification
...
## Scope
Validate `specs/extracted/memory-system.md` behavior via running-app interfaces only (CLI, gateway APIs, channels, MCP/tool calls).
...
- Validate **Architecture Layers** through real CLI/API/channel interactions.
- Validate **Memory Interface** through real CLI/API/channel interactions.
- Validate **Storage Backends** through real CLI/API/channel interactions.
- Validate **Session Store** through real CLI/API/channel interactions.
- Validate **Retrieval Engine** through real CLI/API/channel interactions.
- Validate **Vector Plane** through real CLI/API/channel interactions.
- Validate **Rollout System** through real CLI/API/channel interactions.
...
## Traceability
- Source spec: `specs/extracted/memory-system.md`
- Bead: `nilclaw-d4o`
