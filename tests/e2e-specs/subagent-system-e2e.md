# E2E Spec: Sub-Agent System Specification
...
## Scope
Validate `specs/extracted/subagent-system.md` behavior via running-app interfaces only (CLI, gateway APIs, channels, MCP/tool calls).
...
- Validate **SubagentManager** through real CLI/API/channel interactions.
- Validate **Task Lifecycle** through real CLI/API/channel interactions.
- Validate **Spawn Flow** through real CLI/API/channel interactions.
- Validate **Execution Modes** through real CLI/API/channel interactions.
- Validate **TaskRunRequest** through real CLI/API/channel interactions.
- Validate **Result Routing** through real CLI/API/channel interactions.
- Validate **Tool Restrictions** through real CLI/API/channel interactions.
...
## Traceability
- Source spec: `specs/extracted/subagent-system.md`
- Bead: `nilclaw-bic`
